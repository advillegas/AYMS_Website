...
export function Hero() {
  return (
    ...
    >
      ...
      {[
        { x: "15%", y: "22%", size: "w-44 h-44", color: "bg-[#B51760]", opacity: "opacity-[0.04]", dur: 9, delay: 0 },
          ...
          >
            ...
            >
              <Image
                ...
                width={110}
                height={110}
                className="mx-auto rounded-full shadow-[0_0_30px_rgb(255_0_153/0.25),0_0_60px_rgb(181_23_96/0.10)]"
              />
            </motion.div>
          ...
          >
            <Link
              ...
              className={cn(
                ...
                "text-base px-10 h-13 bg-gradient-to-r from-[#FF0099] via-[#B51760] to-[#FF0099] text-white border-0 hover:brightness-110 shadow-[0_0_20px_rgb(255_0_153/0.20)] animate-shimmer font-semibold tracking-wide",
              )}
            >
              Become an Amiga ♡
            </Link>
