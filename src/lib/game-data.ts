...
export const DESTINATIONS: Destination[] = [
  ...
  { id: "japan", name: "Tokyo", country: "Japan", emoji: "🇯🇵", gradient: "from-[#FF0099] to-[#9B2C8A]", traits: { culture: 4, learning: 4, adventure: 2 }, description: "Ancient temples meet neon streets, cherry blossoms, and ramen", whyYou: "You're endlessly curious and love contrast — traditional tea ceremonies one hour, robot restaurants the next." },
  ...
  { id: "nyc", name: "New York City", country: "USA", emoji: "🗽", gradient: "from-[#9B2C8A] to-[#FF0099]", traits: { social: 4, luxury: 3, culture: 2 }, description: "Broadway, rooftop bars, food from every corner of the globe", whyYou: "You love the energy of a city that never sleeps. Shopping, shows, and skyline views with your amigas — perfection." },
...
export const MAP_CITIES: MapCity[] = [
  { id: "cancun", name: "Cancún", country: "Mexico", emoji: "🇲🇽", x: 22, y: 48, storyId: "cancun", gradient: "from-[#00BCD4] to-[#FF0099]" },
  { id: "nyc", name: "New York", country: "USA", emoji: "🗽", x: 26, y: 38, storyId: "nyc", gradient: "from-[#9B2C8A] to-[#FF0099]" },
  { id: "cartagena", name: "Cartagena", country: "Colombia", emoji: "🇨🇴", x: 24, y: 55, storyId: "cartagena", gradient: "from-[#DAA520] to-[#FF0099]" },
  ...
  { id: "tokyo", name: "Tokyo", country: "Japan", emoji: "🇯🇵", x: 82, y: 38, storyId: "tokyo", gradient: "from-[#FF0099] to-[#9B2C8A]" },
  { id: "bali", name: "Bali", country: "Indonesia", emoji: "🏝️", x: 78, y: 62, storyId: "bali", gradient: "from-[#2D8B6F] to-[#DAA520]" },
  { id: "paris", name: "Paris", country: "France", emoji: "🇫🇷", x: 48, y: 34, storyId: "paris", gradient: "from-[#FF0099] to-[#FF6BA8]" },
];
